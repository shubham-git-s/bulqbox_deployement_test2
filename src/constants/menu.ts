...
const MENU_ITEMS: MenuItemTypes[] = [
...

    {
        ...
        children: [
            {
                key: 'update-excel-sheet',
                label: 'Upload/Update Excel Sheet',
                url: '/inventory-management/upload-excel-sheet',
                parentKey: 'inventory-management',

            },
            {
                key: 'real-time-inventory',
                label: 'Real-Time Inventory',
                url: '/inventory-management/real-time-inventory',
                parentKey: 'inventory-management',
            },
        ],
    },
        ...
        children: [
            {
                ...
                parentKey: 'order-management',

            },
            {
                key: 'order-management-detail',
                label: 'Detail',
                url: '/order-management/detail',
                parentKey: 'order-management',
            },
        ],
    },
        ...
        children: [
            {
                ...
                url: '/buyer-management/extraction-tool',
                parentKey: 'buyer-data-management',

            },
            {
                key: 'interaction-history-view',
                label: 'Interaction History Viewer',
                url: '/buyer-management/interaction-history-view',
                parentKey: 'buyer-data-management',
            },
        ],
    },
    ...
    {
        key: 'repors-analytics',
        label: 'Reports And Analytics',
        isTitle: false,
        icon: 'mdi mdi-table',
        children: [
            {
                key: 'report-generation-tool',
                label: 'Report Generation Tool',
                url: '/repors-analytics/report-generation-tool',
                parentKey: 'repors-analytics',
            },
            {
                key: 'interactive-analytic-charts',
                label: 'Interactive Analytics Charts',
                url: '/repors-analytics/interactive-analytic-charts',
                parentKey: 'repors-analytics',
