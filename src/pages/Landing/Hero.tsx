                        ...
                        <Row className="align-items-center">
                            <Col lg={6} sm={6}>
                                <div className="home-title">
                                    <h5 className="mb-3 text-white-50">Discover BulqBox Today</h5>
                                    <h2 className="mb-4 text-white">Make your Site Amazing & Unique with BulqBox</h2>
                                    <p className="text-white-50 home-desc font-16 mb-5">
                                    BulqBox is a fully featured premium Landing template built on top of awesome
