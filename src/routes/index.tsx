...
import orderList from '../pages/apps/Order-Management/list';
...
const InventoryManagement = React.lazy(() => import('../pages/apps/Inventory-Management/Real-Time-Inventory/list'));
const ExcelSheet = React.lazy(() => import('../pages/apps/Inventory-Management/Upload-Excel-Sheet/ExcelSheet'));

// Order Management
const OrderManagementList = React.lazy(() => import('../pages/apps/Order-Management/list'));
const OrderManagementDetail = React.lazy(() => import('../pages/apps/Order-Management/detail'));

// Buyer Data Management
const BuyerExtractionTool = React.lazy(() => import('../pages/apps/Buyer-Data-Management/Extraction-Tool'))
const BuyerInteractionHistoryView = React.lazy(() => import('../pages/apps/Buyer-Data-Management/Interaction-History-View'))

// Report And Analytics
const ReportGenerationTool = React.lazy(() => import('../pages/apps/Reports-Analytics/Report-Generation-Tool'))
const InteractiveAnalyticsChart = React.lazy(() => import('../pages/apps/Reports-Analytics/Interactive-Analytics-Charts'))
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              path: 'upload-excel-sheet',
              element: <LoadComponent component={ExcelSheet} />,
            },
            {
        ...
        },
        {
          ...
          children: [
            {
              path: 'list',
              element: <LoadComponent component={OrderManagementList} />,
            },
            {
              path: 'detail',
              element: <LoadComponent component={OrderManagementDetail} />,
            },
          ]
        },
        {
          ...
          children: [
            {
              path: 'extraction-tool',
              element: <LoadComponent component={BuyerExtractionTool} />,
            },
            {
              path: 'interaction-history-view',
              element: <LoadComponent component={BuyerInteractionHistoryView} />,
            },
          ]
        },
        {
          path: 'repors-analytics',
          children: [
            {
              path: 'report-generation-tool',
              element: <LoadComponent  component={ReportGenerationTool} />,
            },
            {
              path: 'interactive-analytic-charts',
              element: <LoadComponent component={InteractiveAnalyticsChart} />,
            },
          ]
        },
        // {
